...
//		new RunExcep().ArithEx();
	...
	public void ArithEx() {
		...
		while (true) {
			...
			if (inputNum == 0) {
				System.out.println("0을 입력, 종료");
				return;
			}

			ran = (int) (Math.random() * 10) + 1;
			result = ran / inputNum;
			System.out.print("나눈 결과:" + result);
	...
	public void ClassNArrayEx() {
		/*
		 * //ClassCastException Object obj = 'a'; System.out.println(obj); String str =
		 * (String)obj; System.out.println(str);
		 */
